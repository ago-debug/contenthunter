...
// Stessi campi della scheda prodotto (Iris)
...
export default function ExportPage() {
    const { alert: appAlert } = useAppDialogs();
    ...
    /** Allineato a ErpTable: sessione aziendale o azienda scelta (admin globale). */
        ...
        const fetchData = async () => {
            try {
                const [brandsRes, categoriesRes] = await Promise.all([
                    ...
                    axios.get("/api/categories?all=true", companyAxiosConfig),
                ]);
    ...
    useEffect(() => {
        ...
        const timeoutId = setTimeout(async () => {
            try {
                ...
                params.set("limit", "50");
                params.set("companyId", String(effectiveCompanyId));
        ...
        try {
            ...
            const res = await fetch(`/api/export${query}`, {
                ...
                headers: {
                    ...
                    ...(effectiveCompanyId != null
                        ? { "x-company-id": String(effectiveCompanyId) }
                        : {}),
                },
            ...
            console.error(err);
            void appAlert(err.message || "Errore durante l'export");
        } finally {
            setExporting(false);
        }
    };
