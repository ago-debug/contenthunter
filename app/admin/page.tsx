        ...
        <div className="p-12 space-y-12 max-w-6xl mx-auto animate-in slide-in-from-bottom-4 duration-500">
            ...
            <section className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-xl shadow-slate-100">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    >
                        <div className="w-14 h-14 bg-orange-50 text-orange-600 rounded-xl flex items-center justify-center group-hover:bg-orange-100 transition-colors">
                            <SlidersHorizontal className="w-7 h-7" />
                        </div>
                        <div>
                            <p className="font-black text-slate-900">Piattaforma &amp; piani</p>
                            <p className="text-xs text-slate-500">Tenant, crediti AI, accessi utente</p>
                        </div>
                    </Link>
                    <Link
            ...
            <footer className="pt-12 border-t border-slate-100 flex justify-between items-center opacity-40">
                <span className="text-[9px] font-black uppercase tracking-[0.4em]">Iris · pannello amministrazione © 2026</span>
