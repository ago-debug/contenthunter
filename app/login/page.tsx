...
function LoginForm() {
    ...
    useEffect(() => {
        ...
        if (v === "1") {
            toast.success("Email verificata. Ora puoi accedere con le tue credenziali.");
        } else if (v === "0") {
            toast.error("Link di verifica non valido. Richiedi un nuovo invito o contatta l’amministratore.");
        } else if (v === "expired") {
            toast.error("Link di verifica scaduto. Contatta l’amministratore o registra di nuovo l’account.");
        }
    }, [searchParams]);
        ...
        try {
            ...
            if (result?.error) {
                ...
                if (err === "CredentialsSignin") {
                    ...
                    toast.error(
                        "Devi verificare l’indirizzo email prima di accedere. Controlla la posta in arrivo e il link che ti abbiamo inviato."
                    );
                } else if (err === "AccessDenied") {
                    toast.error(
                        "Accesso non consentito: account disattivato oppure workspace non ancora approvato dall’amministratore."
                    );
                } else {
                    toast.error(
            ...
            <div className="hidden lg:flex flex-col justify-between p-12 bg-[#111827] relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <h1 className="text-5xl font-black text-white leading-tight mb-8">
                        Accedi a <br /> <span className="text-orange-500">Iris</span>
                    </h1>
                    <p className="text-gray-400 text-lg font-bold max-w-md">
                        Biblioteca prodotti: anagrafica, contenuti multilingua e integrazioni canali in un unico ambiente.
                    </p>
                </div>
            ...
            <div className="flex items-center justify-center p-8 bg-white lg:bg-transparent">
                <div className="w-full max-w-md">
                    <div className="lg:hidden text-center mb-12">
                        <h1 className="text-3xl font-black text-[#111827] mb-2">Iris</h1>
...
export default function LoginPage() {
    return (
        <Suspense
            fallback={
                <div className="min-h-screen flex items-center justify-center bg-[#F4F5F7] text-sm font-bold text-gray-500">
                    Caricamento…
                </div>
            }
        >
