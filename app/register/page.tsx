...
import { Lock, Mail, ArrowRight, UserPlus, User, CheckCircle2, Building2 } from "lucide-react";
...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                toast.success(data.message || "Richiesta registrata. Dopo l’approvazione potrai accedere.");
                router.push("/login");
            } else {
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white p-12 rounded-[2.5rem] shadow-[0_40px_100px_rgba(0,0,0,0.08)] border border-gray-100">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-1.5">
                                <label className="text-[11px] font-black text-gray-400 uppercase tracking-widest ml-4 block">Nome workspace / azienda</label>
                                <div className="relative group">
                                    <Building2 className="absolute left-6 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-300 group-focus-within:text-orange-500 transition-colors" />
                                    <input
                                        required
                                        type="text"
                                        value={companyName}
