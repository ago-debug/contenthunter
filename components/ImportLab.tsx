...
export default function ImportLab() {
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-80px)] overflow-hidden">
            {/* Control Bar */}
            <div className="h-auto bg-white border-b border-slate-100 flex flex-col items-stretch px-4 sm:px-8 py-4 gap-4 shrink-0 shadow-sm z-10 w-full">
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    {/* Repository Title & Basic Details */}
                    <div className="flex items-center gap-4 min-w-0 flex-1">
                        ...
                        <div className="min-w-0">
                            ...
                            <span className="flex items-center gap-1.5 text-[10px] font-black uppercase tracking-widest text-slate-400 mt-1 truncate">
                                <HardDrive className="w-3 h-3 shrink-0" />
                                <span>{repository.imageFolderPath || "No Image Folder"}</span>
                            </span>
                        </div>
                    </div>

                    {/* Master Action Button (Important) */}
                    <div className="flex items-center gap-2 shrink-0">
                        <button className="w-full sm:w-auto px-8 py-2.5 bg-slate-900 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-black transition-all shadow-xl shadow-slate-200 flex items-center justify-center gap-2">
                ...
                {/* Secondary Bar: Metadata Files & Action Buttons */}
                <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4 pt-2 border-t border-slate-50">
                    <div className="flex flex-wrap items-center gap-3">
                        ...
                        {repository.lastListinoName && (
                            <div className="flex items-center gap-1.5 bg-orange-50 text-orange-600 px-2.5 py-1.5 rounded-lg border border-orange-100/50 max-w-[250px]">
                                <FileSpreadsheet className="w-3.5 h-3.5 text-orange-400 shrink-0" />
                                <span className="text-[10px] font-black uppercase tracking-widest truncate">{repository.lastListinoName}</span>
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        <button
                            ...
                            className="flex-1 sm:flex-none px-4 py-2 bg-white border border-slate-200 text-slate-900 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-slate-50 transition-all shadow-sm flex items-center justify-center gap-2"
                        >
                        ...
                        <button
                            ...
                            className="px-3 py-2 bg-white border border-slate-200 text-slate-900 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-slate-50 transition-all shadow-sm flex items-center justify-center gap-2"
                        >
            ...
            <div className="flex flex-col lg:flex-row flex-1 overflow-y-auto lg:overflow-hidden">
                ...
                {repository.pdfs?.length > 0 && (
                    <div className="w-full lg:w-[400px] xl:w-[450px] border-t lg:border-t-0 lg:border-l border-slate-100 bg-white flex flex-col shrink-0">
                        <div className="p-4 sm:p-6 border-b border-slate-50 flex flex-col gap-4">
                            <div className="flex items-center justify-between gap-2 overflow-hidden">
                                <h4 className="text-[10px] font-black uppercase tracking-widest text-slate-400 flex items-center gap-2 shrink-0">
                            ...
                            <select
                                className="w-full text-[10px] font-black uppercase tracking-widest bg-slate-50 border border-slate-100 rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-orange-100 transition-all truncate"
                                value={currentPdfIdx}
