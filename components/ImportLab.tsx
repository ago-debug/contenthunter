            ...
            <div className="bg-white border-b border-slate-100 flex flex-col p-4 sm:px-8 sm:py-6 gap-6 shrink-0 shadow-sm z-10 w-full">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <button className="flex-1 sm:flex-none px-8 py-3 bg-slate-900 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-black transition-all shadow-xl shadow-slate-200 flex items-center justify-center gap-2">
                ...
                {/* Second Row: Detailed Metadata (Path/Files) */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-slate-50">
                    <div className="flex flex-col gap-2">
                        <div className="flex items-center gap-2 text-slate-400">
                            <HardDrive className="w-3.5 h-3.5 shrink-0" />
                            <span className="text-[10px] font-black uppercase tracking-widest truncate">{repository.imageFolderPath || "No Image Folder"}</span>
                        </div>
                        <div className="flex flex-wrap items-center gap-2">
                            ...
                            {repository.lastListinoName && (
                                <div className="inline-flex items-center gap-1.5 bg-orange-50 text-orange-600 px-2.5 py-1 rounded-lg border border-orange-100/50 max-w-full">
                                    <FileSpreadsheet className="w-3 h-3 text-orange-400 shrink-0" />
                                    <span className="text-[9px] font-black uppercase tracking-widest truncate">{repository.lastListinoName}</span>
                    ...
                    <div className="flex flex-wrap items-center gap-2 md:justify-end">
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-white border border-slate-200 text-slate-900 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-slate-50 transition-all shadow-sm flex items-center gap-2"
                        >
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-white border border-slate-200 text-slate-900 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-slate-50 transition-all shadow-sm flex items-center gap-2"
                        >
                            {isUploadingPdf ? <RefreshCw className="w-3.5 h-3.5 animate-spin text-orange-500" /> : <FileText className="w-3.5 h-3.5 text-orange-600" />}
                            PDF
                        </button>
                        <button
                        ...
                        <button onClick={handlePdfSearch} className="p-2 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-all shadow-sm text-slate-500">
